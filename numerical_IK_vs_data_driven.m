                ...
                for j = 1:length(indexes)
                    ...
                    for s=1:samples
                        ...
                        while(final == 0)
                            ...
                            if contains(robot, "7DoF") || contains(robot, "6DoF") 
                    ...
                    %% save the tables of the results to be analyzed
                        ...
                        if contains(robot, "6DoF")
                            ...
                            dataset_t = table(summaryTable(:,1), summaryTable(:,2), summaryTable(:,3), summaryTable(:,4), summaryTable(:,5), summaryTable(:,6), summaryTable(:,7), ...
                                              ...
                                              summaryTable(:,30), summaryTable(:,31),summaryTable(:,32),...
                                              'VariableNames',varNames);
                            writetable(dataset_t, strcat(motion,'/','results_',robot,'_',str_unit_chosen,'_', inverse_chosen ,'_', num2str(alpha) ,'_seq_',num2str(seq),'.csv'),'Delimiter',',')
                        end
