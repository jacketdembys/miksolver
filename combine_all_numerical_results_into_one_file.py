...
if __name__ == '__main__':
    ...
    for robot_call in robot_calls:
        ...
        for inverse in inverses:
            ...
            print(base_path)
            csv_files = [base_path+f'/compiled_results_'+robot_call+'_m_'+inverse+'_1_seq_'+str(i)+'.csv' for i in range(2,22,2)]
            ...
            combined_df.to_csv(os.path.join(base_path, 'combined_results_'+robot_call+'_m_'+inverse+'_1.csv'), index=False)
